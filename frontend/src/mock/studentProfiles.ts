...
export const STUDENT_PROFILES: Record<AcademicStream, StudentProfile> = {
  tech_ai: {
    ...
    livingResumeRankings: [
      ...
      { domain: 'Data Structures & Algorithms', percentile: '98.7th', badge: 'Top 1.3%', icon: '', color: 'text-orange-600 dark:text-orange-400', border: 'border-orange-200 dark:border-orange-500/30' },
      ...
      { domain: 'Code Uniqueness & Veracity', percentile: '99.8th', badge: 'Top 0.2%', icon: '', color: 'text-amber-700 dark:text-amber-300', border: 'border-amber-200 dark:border-amber-500/30' }
    ],
  ...
  commerce_finance: {
    ...
    livingResumeRankings: [
      ...
      { domain: 'Quantitative Econometrics', percentile: '97.2nd', badge: 'Top 2.8%', icon: '', color: 'text-orange-600 dark:text-orange-400', border: 'border-orange-200 dark:border-orange-500/30' },
      ...
      { domain: 'Audited Model Integrity', percentile: '99.5th', badge: 'Top 0.5%', icon: '', color: 'text-amber-700 dark:text-amber-300', border: 'border-amber-200 dark:border-amber-500/30' }
    ],
    skillBridgeInterventions: [
      {
        type: 'Certification',
  ...
  healthcare_bio: {
    ...
    livingResumeRankings: [
      ...
      { domain: 'Ontology Mapping (ICD-11)', percentile: '99.9th', badge: 'Top 0.1%', icon: '', color: 'text-amber-600 dark:text-amber-400', border: 'border-amber-200 dark:border-amber-500/30' },
      { domain: 'Clinical Biostatistics', percentile: '97.8th', badge: 'Top 2.2%', icon: '', color: 'text-orange-600 dark:text-orange-400', border: 'border-orange-200 dark:border-orange-500/30' },
      { domain: 'Phytopharmacology & GCP', percentile: '98.5th', badge: 'Top 1.5%', icon: '', color: 'text-amber-700 dark:text-amber-300', border: 'border-amber-200 dark:border-amber-500/30' }
    ],
    skillBridgeInterventions: [
      {
        type: 'Certification',
  ...
  law_governance: {
    ...
    livingResumeRankings: [
      ...
      { domain: 'Tech Contracts & Licensing', percentile: '98.1st', badge: 'Top 1.9%', icon: '', color: 'text-orange-600 dark:text-orange-400', border: 'border-orange-200 dark:border-orange-500/30' },
      ...
      { domain: 'M&A Due Diligence', percentile: '96.8th', badge: 'Top 3.2%', icon: '', color: 'text-amber-700 dark:text-amber-300', border: 'border-amber-200 dark:border-amber-500/30' }
    ],
    skillBridgeInterventions: [
      {
        type: 'Certification',
  ...
  ui_ux: {
    ...
    livingResumeRankings: [
      ...
      { domain: 'Design Systems Architecture', percentile: '98.8th', badge: 'Top 1.2%', icon: '', color: 'text-orange-600 dark:text-orange-400', border: 'border-orange-200 dark:border-orange-500/30' },
      { domain: 'Spatial & Multimodal UI', percentile: '98.2nd', badge: 'Top 1.8%', icon: '', color: 'text-amber-700 dark:text-amber-300', border: 'border-amber-200 dark:border-amber-500/30' },
