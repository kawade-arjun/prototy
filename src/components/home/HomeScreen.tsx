...
export const HomeScreen: React.FC<HomeScreenProps> = ({ onSelectRole }) => {
  ...
  return (
    <div className="space-y-16 py-4 sm:py-8 max-w-6xl mx-auto animate-fadeIn relative">
      ...
      {/* SECTION 4: STACKED STAKEHOLDER DEEP-DIVE & VECTOR SVG DIAGRAM STUDIO */}
      <div id="stakeholder-deep-dive" className="space-y-12 pt-8 border-t border-[#E5DFD3] dark:border-amber-500/20">
        ...
        <div className="text-center space-y-3">
          ...
          <h2 className="font-serif-luxury text-2xl sm:text-4xl font-bold text-slate-900 dark:text-white tracking-tight">
            Stakeholder Overview & Visual Architecture
          </h2>
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium">
            Complete feature breakdown, competency index models, and real-time SVG vector diagnostics for all 4 platform roles
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-3">
            <button
              onClick={() => handleExploreStakeholder('student')}
              className="px-3.5 py-1.5 rounded-full text-xs font-extrabold bg-white dark:bg-[#0c1222] text-slate-700 dark:text-slate-300 border border-amber-500/30 hover:border-amber-500 hover:text-amber-600 transition-all cursor-pointer flex items-center gap-1.5 shadow-sm"
            >
        ...
        {/* SECTION 1: STUDENT & JOB SEEKER STAKEHOLDER OVERVIEW */}
        <div 
          id="deep-dive-student" 
          className={`space-y-6 p-6 sm:p-8 rounded-3xl border transition-all duration-700 ${
            highlightedRole === 'deep-dive-student' 
              ? 'ring-4 ring-amber-500/60 border-amber-500 shadow-2xl bg-amber-500/5 scale-[1.005]' 
              : 'border-amber-500/20 bg-white/50 dark:bg-[#0a0f1d]/50'
          }`}
        >
          <div className="flex items-center gap-3 border-b border-amber-500/20 pb-4">
            ...
            <div>
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">ROLE OVERVIEW 1 OF 4</span>
              <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Student & Job Seeker Architecture</h3>
            </div>
          </div>

          {/* 3 Feature Boxes with Requested Structure & Google Standard Icons */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            
            {/* Box 1 (Data from former 2nd box: ATS Skill Gap Studio) */}
            ...
            <div className="p-5 rounded-2xl bg-white dark:bg-[#0e1526] border border-amber-500/20 space-y-3 shadow-sm hover:border-amber-500/50 transition-all">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-serif-luxury font-bold text-slate-900 dark:text-white text-base">Skill Verification Ledger</h4>
                  <span className="text-[11px] font-mono text-amber-700 dark:text-amber-300">DigiLocker Sovereign Verification</span>
                </div>
              </div>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Cryptographically verifies academic transcripts, proctored code sandbox badges, and verified skill credentials via DigiLocker sovereign identity.
              </p>
            </div>

            {/* Box 3 (Continuous Assessments, Projects, Internships & Jobs Info) */}
            <div className="p-5 rounded-2xl bg-white dark:bg-[#0e1526] border border-amber-500/20 space-y-3 shadow-sm hover:border-amber-500/50 transition-all">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center font-bold">
                  <Briefcase className="w-5 h-5" />
                ...
                <div>
                  <h4 className="font-serif-luxury font-bold text-slate-900 dark:text-white text-base">Continuous Diagnostics & Jobs</h4>
                  <span className="text-[11px] font-mono text-amber-700 dark:text-amber-300">Proctored Sandboxes & Career Pipeline</span>
                </div>
              </div>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Tracks 0-100 competency telemetry from compiler sandboxes, hands-on projects, verified internships, and automated placement job matches.
              </p>
            </div>
          </div>

          {/* Student Vector Diagrams */}
        ...
        {/* SECTION 2: COLLEGE PLACEMENT CELL (TPO) STAKEHOLDER OVERVIEW */}
        <div 
          id="deep-dive-college" 
          className={`space-y-6 p-6 sm:p-8 rounded-3xl border transition-all duration-700 ${
            highlightedRole === 'deep-dive-college' 
              ? 'ring-4 ring-amber-500/60 border-amber-500 shadow-2xl bg-amber-500/5 scale-[1.005]' 
              : 'border-amber-500/20 bg-white/50 dark:bg-[#0a0f1d]/50'
          }`}
        >
          <div className="flex items-center gap-3 border-b border-amber-500/20 pb-4">
            ...
            <div>
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">ROLE OVERVIEW 2 OF 4</span>
              <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">College Placement Cell (TPO) Architecture</h3>
            </div>
          </div>
        ...
        {/* SECTION 3: CORPORATE RECRUITER STAKEHOLDER OVERVIEW */}
        <div 
          id="deep-dive-recruiter" 
          className={`space-y-6 p-6 sm:p-8 rounded-3xl border transition-all duration-700 ${
            highlightedRole === 'deep-dive-recruiter' 
              ? 'ring-4 ring-amber-500/60 border-amber-500 shadow-2xl bg-amber-500/5 scale-[1.005]' 
              : 'border-amber-500/20 bg-white/50 dark:bg-[#0a0f1d]/50'
          }`}
        >
          <div className="flex items-center gap-3 border-b border-amber-500/20 pb-4">
            ...
            <div>
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">ROLE OVERVIEW 3 OF 4</span>
              <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Corporate Recruiter Console Architecture</h3>
            </div>
          </div>
        ...
        {/* SECTION 4: GOVERNMENT & AICTE STAKEHOLDER OVERVIEW */}
        <div 
          id="deep-dive-government" 
          className={`space-y-6 p-6 sm:p-8 rounded-3xl border transition-all duration-700 ${
            highlightedRole === 'deep-dive-government' 
              ? 'ring-4 ring-amber-500/60 border-amber-500 shadow-2xl bg-amber-500/5 scale-[1.005]' 
              : 'border-amber-500/20 bg-white/50 dark:bg-[#0a0f1d]/50'
          }`}
        >
          <div className="flex items-center gap-3 border-b border-amber-500/20 pb-4">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-amber-700 to-yellow-600 text-white flex items-center justify-center shadow-md">
              <Landmark className="w-5 h-5" />
            </div>
            <div>
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">ROLE OVERVIEW 4 OF 4</span>
              <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Government & AICTE Policy Observatory Architecture</h3>
            </div>
          </div>
