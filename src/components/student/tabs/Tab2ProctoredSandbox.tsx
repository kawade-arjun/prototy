        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center gap-2">
              <span className="text-[9px] font-mono font-black uppercase px-2 py-0.5 rounded-md bg-indigo-50 text-indigo-700 border border-indigo-200 dark:bg-indigo-500/20 dark:text-indigo-300 dark:border-indigo-500/30">
                ENGINE OF PROOF
              </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredTests.map((test) => {
          ...
          return (
            <div
              key={test.id}
              className="glass-panel p-4 sm:p-5 rounded-2xl flex flex-col justify-between space-y-3 hover:border-indigo-400 dark:hover:border-indigo-500/40 transition-all duration-300 shadow-sm hover:shadow-lg group hover:-translate-y-0.5"
            >
              <div className="space-y-2.5">
                ...
                {/* Title */}
                <h3 className="font-extrabold text-slate-900 dark:text-white text-sm sm:text-base group-hover:text-indigo-600 dark:group-hover:text-cyan-300 transition-colors leading-snug">
                  {test.title}
                </h3>

                {/* Benchmarking Entity */}
                <div className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400">
                  <div className="w-5 h-5 rounded-md bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300 font-bold text-[9px] flex items-center justify-center border border-indigo-200 dark:border-indigo-800 shrink-0">
                ...
                <div className="flex flex-wrap gap-1 pt-0.5">
                  {test.skillTags.map((tag) => (
                    <span
                      key={tag}
                      className="text-[10px] px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              {/* Score & Status Indicator Bar */}
              <div className="pt-3 border-t border-slate-100 dark:border-white/[0.08] space-y-2.5">
                {isCompleted ? (
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-[9px] font-bold text-slate-400 uppercase">Evaluation Score</div>
                      <div className="text-sm sm:text-base font-black text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                        <CheckCircle2 className="w-3.5 h-3.5" /> Score: {test.score}% • Cleared
                      </div>
                    </div>
                    <button
                      onClick={() => setDiagnosticReportTest(test)}
                      className="px-3 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-bold transition-all"
                    >
                      View Report
                    </button>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-500 text-[11px]">In Progress ({test.progressPercent}%)</span>
                      <span className="text-amber-500 font-bold text-[11px]">Auto-Saved</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => handleLaunchTest(test)}
                      className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-sm shadow-indigo-600/20 transition-all active:scale-95"
                    >
        ...
        <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-xl flex flex-col animate-fadeIn">
          ...
          <div className="bg-[#0a0f1d] border-b border-white/[0.1] px-6 py-3.5 flex flex-wrap items-center justify-between gap-4 text-white">
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-mono font-bold px-2.5 py-1 rounded bg-indigo-950 text-cyan-300 border border-indigo-800">
                {activeTest.id}
              </span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-indigo-500/20 border border-indigo-500/40 text-cyan-300 font-mono text-xs font-black shadow-inner">
                ...
                <div className="flex-1 flex flex-col h-full">
                  <div className="bg-[#0b101e] px-4 py-2.5 border-b border-white/[0.08] flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md active:scale-95"
                    >
                ...
                <div className="p-6 overflow-y-auto space-y-5 text-white">
                  ...
                  <div className="p-5 rounded-2xl bg-[#080c16] border border-white/[0.08] space-y-3 font-mono text-xs">
                    ...
                    <div className="grid grid-cols-3 gap-2 py-1">
                      ...
                      <div className="text-cyan-300">3.50x EBITDA (₹525 Cr)</div>
                      <div className="text-emerald-400">100% Repaid via Cash Sweep</div>
                    </div>
                    <div className="grid grid-cols-3 gap-2 py-1">
                      <div>Mezzanine Notes</div>
                      <div className="text-cyan-300">2.00x EBITDA (₹300 Cr)</div>
                ...
                <div className="p-6 overflow-y-auto space-y-5 text-white">
                  ...
                  <div className="grid grid-cols-3 gap-3 font-mono text-xs">
                    ...
                    <div className="p-4 rounded-2xl bg-[#080c16] border border-white/[0.08]">
                      ...
                      <div className="text-xl font-bold text-cyan-400">Valid State</div>
                    </div>
                  </div>
              ...
              {activeTest.stream === 'healthcare_bio' && (
                <div className="p-6 overflow-y-auto space-y-5 text-white">
                  ...
                  <div className="p-4 rounded-2xl bg-[#080c16] border border-white/[0.08] font-mono text-xs space-y-2">
                    ...
                    <div className="text-cyan-300 font-bold">Log-Rank Test p-value: 0.004 (Statistically Significant)</div>
                  </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="glass-panel-glow max-w-2xl w-full rounded-3xl p-7 border border-white/[0.15] space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-start justify-between">
              <div>
                <span className="text-[10px] font-mono font-bold uppercase px-2.5 py-0.5 rounded bg-indigo-50 text-indigo-700 border border-indigo-200 dark:bg-indigo-950 dark:text-cyan-300 dark:border-indigo-800">
            ...
            {diagnosticReportTest.skillBridgeRecommendation && (
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#080d1a] border border-slate-200 dark:border-white/[0.08] space-y-2">
                ...
                <button
                  ...
                  className="text-xs text-indigo-600 dark:text-cyan-400 font-bold flex items-center gap-1 hover:underline pt-1"
                >
